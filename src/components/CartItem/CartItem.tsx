  ...
  return (
    ...
    >
        ...
        <div className={styles.cart__item}>
          ...
          <div className={styles.book__details} style={{paddingLeft: 8, paddingRight: 8}}>
            ...
            <div className={styles.book__rating}>
              <div 
                className={styles.book__rating__stars} 
                style={{"--rating": item.book.volumeInfo.averageRating ?? 0} as React.CSSProperties}>
              </div>
              <div className={styles.book__rating__reviews}>
                {item.book.volumeInfo.ratingsCount ?? 0} reviews
              </div>
            </div>
          </div>
        </div>
      ...
      <div className={styles.quantity}>
        ...
        <div className={`${styles.delivery} ${styles.delivery__small}`}>
          Shipping: delivery
        </div>
      </div>
