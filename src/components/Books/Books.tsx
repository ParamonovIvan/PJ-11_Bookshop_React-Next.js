    ...
    >
      <div className={styles.book__poster}>
        {book.volumeInfo.imageLinks ?
          ...
          <Image
            src={NoImage}
            alt={"No picture"} width={212} height={295}
          />
        }
      </div>
      <div className={styles.book__details}>
        ...
        <div className={styles.book__rating}>
          <div className={styles.book__rating__stars} 
            style={{"--rating": book.volumeInfo.averageRating ?? 0} as React.CSSProperties}>
          </div>
          <div className={styles.book__rating__reviews}>
        ...
        <div className={styles.book__price}>
          {book.saleInfo.listPrice?.amount ?? "NOT FOR SALE"} 
...
const Books = (props: BooksProps) => {
  ...
  return (
    <section className={styles.book__section}>
