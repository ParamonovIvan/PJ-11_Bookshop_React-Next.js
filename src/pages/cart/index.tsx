    ...
    <>
      <Head>
        ...
        <section className={styles.cart}>
          <div>
            <h1 className={styles.cart__big__text}>SHOPPING CART</h1>
          </div>
          {items.length === 0 && 
            ...
            {items.length !== 0 &&
              ...
              >
                <div>
                  <div className={styles.cart__table}>
                    <div className={styles.row}>
                      ...
                      <div className={`${styles.cart__table__header} ${styles.header__large__screen}`}>
                        Price
                      </div>
                      <div className={`${styles.cart__table__header} ${styles.header__large__screen}`}>
                        Delivery
                ...
                <div className={styles.cart__footer}>
                  <p className={styles.cart__big__text}>TOTAL PRICE: {getTotalPrice(items).toFixed(2)} {items[0].book.saleInfo.listPrice?.currencyCode}</p>
